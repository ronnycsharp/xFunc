...
namespace xFunc.Maths.Analyzers {
    ...
    public class Simplifier : ISimplifier {
        ...
        public virtual IExpression Analyze(NDerivative exp) {
            exp.Expression = exp.Expression.Analyze(this);

            return exp;
        }

        public virtual IExpression Analyze(DefiniteIntegral exp) {
        ...
        [ExcludeFromCodeCoverage]
        public virtual IExpression Analyze(Fract exp) {
            return AnalyzeUnary(exp);
        }
        ...
        [ExcludeFromCodeCoverage]
        public virtual IExpression Analyze(RoundUnary exp) {
            return AnalyzeUnary(exp);
        }
