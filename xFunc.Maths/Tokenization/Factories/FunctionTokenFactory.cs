...
namespace xFunc.Maths.Tokenization.Factories
{
    ...
    public class FunctionTokenFactory : FactoryBase
    {
        ...
        protected override FactoryResult CreateTokenInternal(Match match, ReadOnlyCollection<IToken> tokens)
        {
            ...
            } else if (lowerMatch == "integral") {
                result.Token = new FunctionToken (Functions.DefiniteIntegral);
            } else if (lowerMatch == "roundunary") {
                result.Token = new FunctionToken (Functions.RoundUnary);
            } else if (lowerMatch == "nderivative") {
                result.Token = new FunctionToken (Functions.NDerivative);
            } else if (lowerMatch == "fract") {
                result.Token = new FunctionToken (Functions.Fract);
            } else if (lowerMatch == "condition") {
                result.Token = new FunctionToken (Functions.Condition);
            } else if (lowerMatch == "multicondition") {
                result.Token = new FunctionToken (Functions.MultiCondition);
            } else if (lowerMatch == "solve") {
                result.Token = new FunctionToken (Functions.Solve);
            } else if (lowerMatch == "rand") {
                result.Token = new FunctionToken (Functions.Rand);
            } else if (lowerMatch == "npr") {
                result.Token = new FunctionToken (Functions.NPr);
            } else if (lowerMatch == "ncr") {
                result.Token = new FunctionToken (Functions.NCr);
            } else {
